          ...
          <table cellspacing="0">
            <tr>
              <td>
                <table class="soapbox">
                  <tr>
                    <td class="soapbox-title">Esqueceu sua senha?</td>
                  </tr>
                </table>
                <table class="body">
                  <tr>
                    ...
                    <td class="body-padded">
                      <div class="body-title">Prezado(a) <?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?>,</div>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <div class="body-title">Obrigada!</div>
                              <p class="body-signature"><a href="https://imgbb.com/"><img src="https://image.ibb.co/nEJzuJ/logokeiko.png"></a></p>
                            </td>
                          </tr>
                        </table>
                      </td>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="#"><b>Get in touch</b></a> Entre em contato conosco se tiver alguma dúvida ou feedback.
          </div>
        </td>
        <td></td>
      </tr>
